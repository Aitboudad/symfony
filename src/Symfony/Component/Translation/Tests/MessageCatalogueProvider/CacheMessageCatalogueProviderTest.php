...
class CacheMessageCatalogueProviderTest extends \PHPUnit_Framework_TestCase
{
    private $tmpDir;
    ...
    {
        $resourceCatalogue = new ResourceMessageCatalogueProvider($loaders, $resources);
        $fallbackMessageCatalogueProvider = new FallbackMessageCatalogueProvider($resourceCatalogue, $fallbackLocales);

        return new CacheMessageCatalogueProvider($fallbackMessageCatalogueProvider, $this->tmpDir, $debug);
    }
